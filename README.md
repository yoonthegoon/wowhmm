...
`tabulate` rounds each value to the penny and returns a formatted table.
...
**No external dependencies required!** This script runs with only Python's standard library.
